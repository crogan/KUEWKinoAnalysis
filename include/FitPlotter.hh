...
public:
    ...
    /*TCanvas* TestDrawingTool(const string& can_name,
                             const VS& proc_bkg,
                             const VS& proc_sig,
                             const CategoryTree& CT,
                             PlotType pType);*/
    ...
    SuperBinList CombineBinsSigAvg(const VS& proc_bkg,
                                   const VS& proc_sig,
                                   const CategoryTree& CT,
                                   double SF = 3,
                                   double sys = 0.1,
    ...
    SuperBinList GetAllBins(const VS& proc_bkg,
                            const VS& proc_sig,
                            const CategoryTree& CT,
                            double SF = 3,
                            double sys = 0.1,
    ...
    SuperBin* GetSuperBin(const VS& proc_bkg,
                          const VS& proc_sig,
                          const CategoryTree& CT,
