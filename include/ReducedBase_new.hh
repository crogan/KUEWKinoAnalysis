...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/t3-ku/crogan/NTUPLES/StopNtuple_new/All_Bkg_2017/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8_Fall17.root");
      if (!f || !f->IsOpen()) {
...
inline void ReducedBase::Init(TTree *tree)
{
   ...
   fChain->SetBranchStatus("dphiCM", 1);
