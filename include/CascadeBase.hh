...
#ifndef CascadeBase_h
#define CascadeBase_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TBranch        *b_c_Njet_b;   //!
   TBranch        *b_c_Nbjet_b;   //!
   TBranch        *b_c_index_jet_b;   //!
   TBranch        *b_c_Nlep_1a;   //!
   TBranch        *b_c_index_lep_1a;   //!
   TBranch        *b_c_Nlep_1b;   //!
   TBranch        *b_c_index_lep_1b;   //!
   TBranch        *b_c_Nlep_2b;   //!
   TBranch        *b_c_index_lep_2b;   //!
   TBranch        *b_PTCM;   //!
   TBranch        *b_PzCM;   //!
   TBranch        *b_cosCM;   //!
   TBranch        *b_dphiCM;   //!
   ...
   TBranch        *b_c_MX3a_S;   //!
   TBranch        *b_c_MX3b_S;   //!
   TBranch        *b_c_MX3a_Vis;   //!
   TBranch        *b_c_MX3b_Vis;   //!
   TBranch        *b_c_MX2a_S;   //!
   TBranch        *b_c_MX2b_S;   //!
   TBranch        *b_c_MX2a_Vis;   //!
   TBranch        *b_c_MX2b_Vis;   //!
   TBranch        *b_MS;   //!
   TBranch        *b_PS;   //!
   TBranch        *b_cosS;   //!
   TBranch        *b_dphiS;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("local_test_root_files/Summer23BPix_130X/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8_Summer23BPix_130X.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("local_test_root_files/Summer23BPix_130X/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8_Summer23BPix_130X.root");
      }
...
Int_t CascadeBase::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CascadeBase::LoadTree(Long64_t entry)
{
...
void CascadeBase::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("c_index_jet_b", &c_index_jet_b, &b_c_index_jet_b);
   fChain->SetBranchAddress("c_Nlep_1a", &c_Nlep_1a, &b_c_Nlep_1a);
   fChain->SetBranchAddress("c_index_lep_1a", &c_index_lep_1a, &b_c_index_lep_1a);
   fChain->SetBranchAddress("c_Nlep_1b", &c_Nlep_1b, &b_c_Nlep_1b);
   fChain->SetBranchAddress("c_index_lep_1b", &c_index_lep_1b, &b_c_index_lep_1b);
   fChain->SetBranchAddress("c_Nlep_2b", &c_Nlep_2b, &b_c_Nlep_2b);
   fChain->SetBranchAddress("c_index_lep_2b", &c_index_lep_2b, &b_c_index_lep_2b);
   ...
   fChain->SetBranchAddress("c_MX3a_S", &c_MX3a_S, &b_c_MX3a_S);
   fChain->SetBranchAddress("c_MX3b_S", &c_MX3b_S, &b_c_MX3b_S);
   fChain->SetBranchAddress("c_MX3a_Vis", &c_MX3a_Vis, &b_c_MX3a_Vis);
   fChain->SetBranchAddress("c_MX3b_Vis", &c_MX3b_Vis, &b_c_MX3b_Vis);
   fChain->SetBranchAddress("c_MX2a_S", &c_MX2a_S, &b_c_MX2a_S);
   fChain->SetBranchAddress("c_MX2b_S", &c_MX2b_S, &b_c_MX2b_S);
   fChain->SetBranchAddress("c_MX2a_Vis", &c_MX2a_Vis, &b_c_MX2a_Vis);
   fChain->SetBranchAddress("c_MX2b_Vis", &c_MX2b_Vis, &b_c_MX2b_Vis);
...
void CascadeBase::Show(Long64_t entry)
{
...
Int_t CascadeBase::Cut(Long64_t entry)
{
