...
def writeSubmissionBase(subf, sampleDir, dataSetName, yearTag):
	...
	subf.write("output = ./MakeNtuple_LPC/"+sampleDir+"/log/job.$(Process).out\n")
	subf.write("error = ./MakeNtuple_LPC/"+sampleDir+"/log/job.$(Process).err\n")
	subf.write("log = ./MakeNtuple_LPC/"+sampleDir+"/log/job.log\n")
