...
datasetname = 'TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_Summer16_102X'
joblist=[1076]
...
print("pushd ../ && condor_submit ./MakeNtuple_Connect/Output/"+datasetname+"/src/resubmit.sh")
