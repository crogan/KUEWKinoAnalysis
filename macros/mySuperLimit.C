...
void FormatTH2D( TH2D* hist, std::string xlabel, std::string ylabel){
...
void mySuperLimit(PlotType s1=kHN2C1, PlotType s2=kTChiWZ, PlotType s3=kTChiWW, PlotType s4=kTSlSnu){
  ...
  std::string f1="/home/jsingera/jsingera/CMSSW_10_6_5/src/KUEWKinoAnalysis_treeSysDev/BF_B135_bugfix16_TChiWZ_MCstats/B135_bugfix16_TChiWZ_limit_canv_smooth.root";
  std::string f2="/home/jsingera/jsingera/CMSSW_10_6_5/src/KUEWKinoAnalysis_treeSysDev/BF_B135_bugfix16_TChipmWW_MCstats/B135_bugfix16_TChipmWW_limit_canv.root";
  std::string f3="/home/jsingera/jsingera/CMSSW_10_6_5/src/KUEWKinoAnalysis_treeSysDev/BF_B135_bugfix16_TSlepSnu_MCstats/B135_bugfix16_TSlepSnu_limit_canv.root";
  std::string f4="/home/jsingera/jsingera/CMSSW_10_6_5/src/KUEWKinoAnalysis_treeSysDev/BF_B135_bugfix16_T2tt_MCstats/B135_bugfix16_T2tt_limit_canv_smooth.root";
  ...
  std::string f6="/home/jsingera/jsingera/CMSSW_10_6_5/src/KUEWKinoAnalysis_treeSysDev/BF_B135_bugfix16_T2cc_MCstats/B135_bugfix16_T2cc_limit_canv.root";
  std::string f7="/home/jsingera/jsingera/CMSSW_10_6_5/src/KUEWKinoAnalysis_treeSysDev/BF_B135_bugfix16_T2bW_MCstats/B135_bugfix16_T2bW_limit_canv.root";
  std::string f8="/home/jsingera/jsingera/CMSSW_10_6_5/src/KUEWKinoAnalysis_treeSysDev/Limit_JSONs/smooth_canvs/B135_bugfix16_HinoN2C1_xsec_smooth_canv.root"; 
  ...
  //z-scale is s1
  TH2D* hist = GetTH2D( limitMap[s1], "h2d");
...
//    ylabel = "#Delta m( ) [GeV]";
  ...
  c->SetLogz(); 
   ...
   FormatTH2D(hist, xlabel, ylabel);
   hist->Draw();
    //FormatTGraph(gexp_vec[0], xlabel, ylabel);
    //gexp_vec[0]->Draw("C");
    //gobs_vec[0]->Draw("same C");

   std::vector<int> colors = {kRed, kBlue, kCyan, kMagenta};
   for(int i=0; i<gexp_vec.size(); i++){	
	FormatLine(gexp_vec[i], 2, colors[i]);		
	FormatLine(gobs_vec[i], 1, colors[i]+3);
   }
   for(int i=0; i<gexp_vec.size(); i++){
...
//   gobs2->Draw("same C");
 ...
 // l.SetTextColor(kWhite);
   l.DrawLatex(0.23, 0.83,"expected");
  line->SetLineColor(kBlack);
  line->SetLineWidth(2);
  line->SetLineStyle(2);
 ...
 if(ptype == kTSlSnu){
  ...
  l.DrawLatex(0.18, 0.87-i*spacing,SMS.c_str());
