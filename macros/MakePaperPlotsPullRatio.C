...
void MakePaperPlotsPullRatio() {

  gROOT->SetBatch(kTRUE);

  // Input BFI file and fit diagnostic
  string inputFile = "/uscms_data/d3/anazario/YOURWORKINGAREA/CMSSW_10_6_5_copy/src/KUEWKinoAnalysis/BFS_B120_BKG161718_DATA161718_TChiWZ161718_T2tt161718_TChipmWW161718_TSlepSlep161718.root";
  ...
  string fitDiagnostic = "fitDiagnosticsDiag.BO.root";
  // Create output file
...
void MakePaperPlot(TFile *saveFile, 
  ...
  TCanvas *canvas = fitPlotter->Plot1DstackPullRatio(string(RmSpace(CTs[0]->GetPlainLabel(depth))+name.c_str()),
						     bkgs,
						     *CTs[0],
						     type,
						     true);
