...
void newReader2D(const string& lep,
	      const string& hadS,
	      const string& hadISR,
	      const string& signal = "",
	      const string& extra = "",
	      const string& inputfile = "FitInput17_T2tt500T2bW500_bkgs_0L1L.root"){
...
//		    "canvas2",
//		    extra);
//  TCanvas* cv = FITReader->Plot2D(VS().a("ZDY").a("ttbar").a("Wjets"),
//		    VS().a(lep),
//		    VS().a(hadS),
//		    VS().a(hadISR),
//		    "canvas3",
//		    extra);
  TCanvas* cv = FITReader->Plot2D(VS().a(signal),
		    VS().a(lep),
		    VS().a(hadS),
		    VS().a(hadISR),
		    "canvas3",
		    extra);
if(cv == NULL) return;
if(!extra.empty()) cv->SaveAs(("/home/t3-ku/mlazarov/Ewkinos/CMSSW_10_6_5/src/KUEWKinoAnalysis/2D_plots/"+signal+"_"+lep+"_"+hadS+"_"+hadISR+"_"+extra+".pdf").c_str());

else cv->SaveAs(("/home/t3-ku/mlazarov/Ewkinos/CMSSW_10_6_5/src/KUEWKinoAnalysis/2D_plots/"+signal+"_"+lep+"_"+hadS+"_"+hadISR+".pdf").c_str());
