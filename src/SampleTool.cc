...
*/
    ...
    //this is the only turned on normally
...
//    InitSMS("TChiWZ",m_Path+"Summer16_102X_SMS/TChiWZ_genHT-160_genMET-80_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_Summer16_102X_RWT.root",1.,true);     
